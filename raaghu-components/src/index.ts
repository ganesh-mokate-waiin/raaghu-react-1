...
export { default as RdsCompNewLanguage } from "./rds-comp-new-language";
...
export { default as RdsCompPropertiesNew } from "./rds-comp-properties-new";
...
export { default as RdsCompElements } from "./rds-comp-elements";
